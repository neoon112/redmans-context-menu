...
command = "powershell -ExecutionPolicy Bypass -WindowStyle Hidden -File ""C:\Apps\RenameTo\Renameto.ps1"" """ & filePath & """ """ & customSuffix & """" ' this calls on the powershell script to rename with the arguments defined before
